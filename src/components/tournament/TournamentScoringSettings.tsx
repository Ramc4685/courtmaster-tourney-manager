...
interface TournamentScoringSettingsProps {
  open: boolean;
...
const TournamentScoringSettings: React.FC<TournamentScoringSettingsProps> = ({
  open,
  onOpenChange,
  maxPoints,
  setMaxPoints,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Tournament scoring settings have been updated successfully"
    });
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Tournament Scoring Settings</DialogTitle>
          <DialogDescription>
            Configure match scoring rules for this tournament
          </DialogDescription>
        </DialogHeader>
...
export default TournamentScoringSettings;
